  ...
  return (
    <div style={{ paddingTop: 72, minHeight: '100vh', background: '#FFFDF8' }}>
      ...
      <section style={{ position: 'relative', padding: '80px 24px 60px', background: 'linear-gradient(135deg, #1C1A18 0%, #2D2820 100%)', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url(https://www.nepaldining.online/wp-content/uploads/2026/06/cheese-naan.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.15 }} />
