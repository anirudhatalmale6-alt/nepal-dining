...
export const FALLBACK_TEAM: TeamMember[] = [
  ...
  {"id":"shreesh-bharat-kumar","name":"SHREESH BHARAT KUMAR","role":"Senior Cook","roleJa":"シニアクック","desc":"Shreesh has been an important part of Nepal Dining since its early years. With extensive knowledge of our cuisine and a strong understanding of the Furano community, he has played a key role in the restaurant's growth and success. His experience, dedication, and commitment to quality continue to help maintain the high standards our guests appreciate.","descJa":"シュリーシュは初期からネパールダイニングの重要なメンバーです。当店の料理に関する豊富な知識と富良野コミュニティへの深い理解により、レストランの成長と成功に重要な役割を果たしてきました。","emoji":"👨‍🍳","photo":"","available":true},
