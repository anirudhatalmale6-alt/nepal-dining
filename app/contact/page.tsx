...
import { FacebookIcon, InstagramIcon, TikTokIcon, XIcon, LineIcon, YouTubeIcon, TripadvisorIcon, MapPinIcon, BRAND } from '../components/SocialIcons';
    ...
    <main className="pt-20">
      ...
      <section className="relative py-24 bg-[#1C1A18] overflow-hidden">
        <div className="absolute inset-0 opacity-20"
          style={{ backgroundImage: "url('https://www.nepaldining.online/wp-content/uploads/2026/06/chicken-tikka-masala.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }} />
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {[
                {
                  ...
                  value: lang === 'en' ? 'Hokkaido, Sorachi Gun,\nNakafurano Cho, Akatsukimachi 3-19' : '北海道空知郡中富良野町曙町3-19',
                  link: null,
                },
                {
                  icon: (
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-[#F0A830]/20">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    { href: 'https://www.facebook.com/nepaldining', label: 'Facebook', Icon: FacebookIcon },
                    { href: 'https://www.instagram.com/nepal_dining_nakafu', label: 'Instagram', Icon: InstagramIcon },
                    { href: 'https://www.tiktok.com/@nepal.dining', label: 'TikTok', Icon: TikTokIcon },
                    { href: 'https://x.com/nepaldining', label: 'X', Icon: XIcon },
                    { href: 'https://lin.ee/Xn5x4lI', label: 'LINE', Icon: LineIcon },
                    { href: 'https://www.youtube.com/@nepaldining', label: 'YouTube', Icon: YouTubeIcon },
                    { href: 'https://www.tripadvisor.com/Restaurant_Review-g1120352-d21322199-Reviews-Nepal_Dining_Nakafurano-Nakafurano_cho_Sorachi_gun_Hokkaido.html', label: 'Tripadvisor', Icon: TripadvisorIcon },
                    { href: 'https://www.google.com/maps?cid=4351573888716021956', label: 'Google Maps', Icon: MapPinIcon },
                  ].map((s) => (
                    <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                      ...
                      style={{ backgroundColor: BRAND[s.label as keyof typeof BRAND] }}
                      aria-label={s.label}>
                      <s.Icon size={20} />
                    </a>
                  ))}
