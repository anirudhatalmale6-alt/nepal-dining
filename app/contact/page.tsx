            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-[#F0A830]/20">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    { href: 'https://facebook.com/nepaldiningfurano', label: 'Facebook', color: '#1877F2', icon: (
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z"/></svg>
                    )},
                    { href: 'https://instagram.com/nepaldiningfurano', label: 'Instagram', color: '#E1306C', icon: (
                    ...
                    { href: 'https://youtube.com/@nepaldiningfurano', label: 'YouTube', color: '#FF0000', icon: (
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    )},
                    { href: 'https://tripadvisor.com', label: 'Tripadvisor', color: '#34E0A1', icon: (
