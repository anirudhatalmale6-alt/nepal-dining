            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-[#F0A830]/20">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    { href: 'https://www.facebook.com/nepaldining', label: 'Facebook', color: '#1877F2', icon: (
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z"/></svg>
                    )},
                    { href: 'https://www.instagram.com/nepal_dining_nakafu', label: 'Instagram', color: '#E1306C', icon: (
                    ...
                    { href: 'https://www.tiktok.com/@nepal.dining', label: 'TikTok', color: '#010101', icon: (
                      <span className="text-base">♪</span>
                    )},
                    { href: 'https://x.com/nepaldining', label: 'X', color: '#000000', icon: (
